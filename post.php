                        ...
                        <div class="layout-fixed">
                            ...
                            <div class="entry-meta">
                                <span class="cat-links">
                                    <?php
                                    if (prev_post($this)){
                                        foreach ( prev_post($this)['categories'] as $key => $value){
                                            echo '<a href="' . $value['permalink'] . '" rel="category tag">' . $value['name'] . '</a>';
                                        }
                                    }
                                    ?>
                                </span>
                            ...
                            <h1 class="entry-title">
                                <?php
                                if (prev_post($this)){
                                    echo '<a href="' . prev_post($this)['permalink'] . '">'. prev_post($this)['title'] .'</a>';
                                }else{
                                    echo "# 404.NotFound!";
                                }
                                ?>
                            ...
                            <div class="entry-meta">
                                <span class="entry-date">
                                    ...
                                    <a href="#">
                                        <?php
                                        if (prev_post($this)){
                                            echo prev_post($this)['date']->format('Y-m-d');
                                        }else{
                                            echo "404.NotFound!";
                                        }
                                        ?>
                                ...
                                <span class="comment-link">
                                    ...
                                    <a href="#">
                                        <?php
                                        if (prev_post($this)){
                                            echo prev_post($this)['commentsNum'] . " 条评论";
                                        }else{
                                            echo "404.NotFound!";
                                        }
                                        ?>
